<?php 
    $services_heading = esc_html(get_theme_mod('services_heading', 'We Introduce To Our Services'));
    $services_text = esc_html(get_theme_mod('services_text', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus corporis enim magnam nesciunt ea aliquam id, sint fugit quae quo'));
